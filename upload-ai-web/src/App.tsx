      ...
      <main className='flex-1 p-6 flex gap-6'>
        ...
        <aside className='w-80 space-y-6'>
          <form className="space-y-6">
            <label
              htmlFor="video"
              className="border rounded-md flex aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5"
            >
          ...
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Select defaultValue='gpt3.5' disabled>
                ...
                <SelectContent>
                  <SelectItem value='gpt3.5'>GPT 3.5-turbo 26k</SelectItem>
                </SelectContent>
              </Select>
